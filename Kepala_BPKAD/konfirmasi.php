                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <table class="table table-hover table-striped">
                                <form class="form-horizontal" action="../data/simpan_data/simpan_kepala.php" method="post">
                                    <thead class="table-primary">
                                        <tr>
                                            <th colspan="2" style="border: 1px solid #D3D3D3;">
                                                <span class="me-2"><i class="fas fa-calendar-alt"></i></span>
                                                Nomor Agenda(<?php echo $no_agenda; ?>
                            ...
                            <table class="table table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr style="border: 1px solid #D3D3D3;">
                                        ...
                                        <td style="border: 1px solid #D3D3D3;">
                                            <a href="DownloadFile.php?url=<?php echo urlencode($berkas); ?>
                                    
                                " target="_blank" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Download">
                                        ...
                                        <tbody>
                                            <tr style="border: 1px solid #D3D3D3; ">
                                                <td style="vertical-align: top;">
                                                    ...
                                                    <input type="hidden" name="tanggal_ajuan" value="<?php echo $tanggal_ajuan; ?>">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
