                                ...
                                <tbody>
                                    <tr style="border: 1px solid #D3D3D3;">
                                        ...
                                        <td>
                                            <?php
                                            if (empty($tindakan)) {
                                                echo '<span class="badge badge-primary" style=" color: white; padding: 5px 10px; border-radius: 10px; font-weight: bold;">pending</span>';
                                            } else {
                                                $background_color = ($tindakan === 'Ajukan ke Kepala BPKAD') ? 'badge badge-success' : 'badge badge-danger';
                                                echo '<span class="' . $background_color . '" style="font-size: 16px; padding: 5px 10px; border-radius: 10px; font-weight: bold;">' . $tindakan . '</span>';
                                            }
                                    ...
                                    <tr style="border: 1px solid #D3D3D3;">
                                        ...
                                        <td style="border: 1px solid #D3D3D3;">
                                            <?php if (isset($berkas) && in_array(pathinfo($berkas, PATHINFO_EXTENSION), ['pdf', 'jpg', 'jpeg', 'png'])) : ?>
                                                <a href="../file/<?php echo basename($berkas); ?>" download class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Unduh">
                                                    <i class="fas fa-download"></i> Unduh
                                                </a>
                                            <?php elseif (isset($berkas)) : ?>
                                                <span class="text-muted">Tipe Berkas Tidak Valid</span>
                                            <?php endif; ?>
                                            <?php if (isset($berkas) && in_array(pathinfo($berkas, PATHINFO_EXTENSION), ['pdf', 'jpg', 'jpeg', 'png'])) : ?>
                                                <a href="../file<?php echo $berkas; ?>" target="_blank" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="View">
                                                    <i class="fas fa-eye"></i> View
                                                </a>
                                            <?php elseif (isset($berkas)) : ?>
                                                <span class="text-muted">Invalid File Type</span>
                                            <?php endif; ?>
                                            <a href="../cetak_disposisi.php?no_surat=<?php echo urlencode($no_surat); ?>&sifat=<?php echo urlencode($sifat); ?>&instansi=<?php echo urlencode($instansi); ?>&no_agenda=<?php echo urlencode($no_agenda); ?>&tanggal_surat=<?php echo urlencode($tanggal_surat); ?>&tanggal_diterima=<?php echo urlencode($tanggal_diterima); ?>&prihal=<?php echo urlencode($prihal); ?>&keterangan=<?php echo urlencode($keterangan); ?>" target="_blank" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Cetak disposisi">
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <<div class="text-muted">Copyright &copy; Arsip BPKAD 2023
                    </div>
                </div>
        </div>
        </footer>
