    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            ...
            <div class="p-4">
                    ...
                    <div class="card-body">
                        <form action="../../data/simpan_data/simpan_tsk.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control datepicker" id="tanggal_keluar" name="tanggal_keluar" placeholder="yyyy-mm-dd" readonly data-provide="datepicker">
