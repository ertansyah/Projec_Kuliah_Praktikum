...
<body class="sb-nav-fixed">
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="../kepala_BPKAD/pending.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-inbox"></i></div>
                            Perlu Konfirmasi
                        </a>
                        <a class="nav-link" href="../kepala_BPKAD/history.php">
                            ...
                            <div class="card bg-primary text-white mb-4">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <p class="mb-0" id="jumlahKonfirmasi">Loading...</p>
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="../kepala_BPKAD/pending.php">Lihat Detail</a>
                            ...
                            <div class="card bg-warning text-white mb-4">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <p class="mb-0" id="historykepala">Loading...</p>
                                    </div>
                                    <div class="d-flex align-items-center">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="../kepala_BPKAD/history.php">Lihat Detail</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="slideContent" class="slide-content">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="../file/Kepala - Buku Petunjuk Arsip BPKAD.pdf" target="_blank"><i class="fas fa-file-pdf"></i>Lihat Buku Petunjuk </a>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                            <h5><i class="fas fa-play-circle"></i> Video Petunjuk</h5>
                                <iframe width="800" height="450" src="https://www.youtube.com/embed/xfYIDzGKwvo" frameborder="0" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            // AJAX request to get the count of pending items
            $.ajax({
                url: '../data/get_data/get_pending_count.php', // Create a new PHP file for this purpose
                type: 'GET',
                success: function(response) {
                    $('#jumlahKonfirmasi').text(response);
                },
                error: function() {
                    $('#jumlahKonfirmasi').text('Error');
                }
            });
        });
    </script>
    <script>
        $(document).ready(function() {
            // AJAX request to get the total count of data entries from history.php
            $.ajax({
                url: '../kepala_BPKAD/history.php?action=getTotalData', // The URL to history.php with an action parameter
                type: 'GET',
                success: function(response) {
                    $('#historykepala').text(response);
                },
                error: function() {
                    $('#historykepala').text('Error');
                }
            });
        });
    </script>
